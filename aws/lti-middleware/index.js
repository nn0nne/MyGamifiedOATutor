...
const oatsHost = "https://cherry-affordable-maps-happens.trycloudflare.com/#"
...
app.post("/launch", async (req, res) => {
    ...
    // console.log(req);
    console.log("Request Body:", JSON.stringify(req.body, null, 2)); // This logs the entire LTI payload
    console.log("Resource Link ID from req.body:", req.body.resource_link_id);
    console.log("User Roles from req.body:", req.body.roles);
    const host = oatsHost;
...
async function catchLegacyLessonID(linkedLesson, provider) {
    if (
        ...
        console.debug(
            `updating legacy numerical lesson id: ${linkedLesson} to ${numericalHashMapping[+linkedLesson]
            }`
        );
...
// module.exports.handler = serverless(app); //aws
module.exports = (req, res) => { app(req, res); }; //vercel
